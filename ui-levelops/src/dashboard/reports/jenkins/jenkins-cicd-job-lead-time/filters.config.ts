...
import { SampleIntervalFilterConfig } from "../jobs-durations-trends-report/specific-filter-config.constants";

export const JenkinsJobsCommitLeadsTrendsReportConfig: LevelOpsFilter[] = [
