...
import { StackFilterConfig } from "../tests-report/specific-filter.config.constants";

export const TestrailsTestEstimateForecastReportFiltersConfig: LevelOpsFilter[] = [
