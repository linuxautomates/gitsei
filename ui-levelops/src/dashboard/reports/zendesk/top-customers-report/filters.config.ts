...
import { TimeFilterConfig } from "dashboard/reports/salesforce/top-customers-report/specific-filter-config.constants";
import { get, uniqBy } from "lodash";
import { LevelOpsFilter } from "model/filters/levelopsFilters";
import { ACROSS_OPTIONS } from "../commonZendeskReports.constants";

export const ZendeskTopCustomersReportFiltersConfig: LevelOpsFilter[] = [
