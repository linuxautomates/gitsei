...
import { HygieneWeightsFiltersConfig, HideScoreFilterConfig } from "../hygiene-report/specific-filters-config.constant";

export const ZendeskHygieneReportTrendsFiltersConfig: LevelOpsFilter[] = [
