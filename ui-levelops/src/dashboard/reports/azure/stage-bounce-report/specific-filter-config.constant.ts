...
import { AZURE_FILTER_KEY_MAPPING } from "../constant";
...
export const StageFilterConfig: LevelOpsFilter = baseFilterConfig((AZURE_FILTER_KEY_MAPPING as any)["workitem_stage"], {
  renderComponent: UniversalSelectFilterWrapper,
  apiContainer: APIFilterContainer,
  label: "Workitem Stage",
