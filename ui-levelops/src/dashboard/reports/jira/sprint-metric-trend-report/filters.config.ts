...
import { AcrossFilterConfig, MetricFilterConfig, MetricViewByFilterConfig } from "./specific-filter-config.constant";
import { filterSpecificFieldsFromFilterConfig } from "dashboard/reports/helper";
import { FILTERS_TO_HIDE } from "./constants";
...
const filteredConfig = filterSpecificFieldsFromFilterConfig(jiraCommonFiltersConfig, FILTERS_TO_HIDE);

export const JiraSprintMetricTrendReportFiltersConfig: LevelOpsFilter[] = [
  ...filteredConfig,
