...
import { ResponseTimeSingleStatType } from "model/report/jira/response-time-single-stat/responseTimeSingleStat.constants";
...
import { JiraResponseTimeSingleStatFiltersConfig } from "./filters.config";
...
const responseTimeSingleStat: { response_time_counts_stat: ResponseTimeSingleStatType } = {
