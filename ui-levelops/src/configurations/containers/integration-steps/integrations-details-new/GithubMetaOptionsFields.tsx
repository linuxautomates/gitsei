...
const GithubMetaOptions: React.FC<GithubMetaOptionsProps> = ({ updateField, metadata }) => {
  return (
    <>
      <Form.Item label={"repositories"} colon={false} key={"repos"}>
        <CommaSelectTag value={metadata?.repos || ""} onChange={(value: string) => updateField("repos", value)} />
      </Form.Item>
...
export default GithubMetaOptions;
