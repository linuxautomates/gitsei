...
import { Dropdown, Icon, InputNumber, Menu, Popover } from "antd";
...
import { AcceptanceTimeSlider } from "configurations/pages/lead-time-profiles/components";
    ...
    () => (
      <div className="stage-criteria-footer">
        <Popover
          ...
          <AntButton type="link" style={{ color: "#23ccef" }}>
