  ...
  useEffect(() => {
    if (!statusList.length) {
      if (hasJiraIntegrtion) {
        ...
        // we need to change it,currently doing it to fix PROP-1687,
        // one existing issue is there, first we have to resolve that
        //dispatch(azureCategoriesFiltersTrellisProfileValues());
