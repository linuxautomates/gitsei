...
import io.levelops.commons.databases.models.database.dev_productivity.IntervalTimeRange;
...
import static io.levelops.commons.databases.services.dev_productivity.DevProductivityParentProfileDatabaseServiceTestUtils.createDevProdParentProfile;
import static org.assertj.core.api.Assertions.assertThat;

public class OrgDevProductivityReportV3DatabaseServiceTest {
    ...
    OrgDevProductivityReportV3DatabaseService orgDevProductivityReportV3DatabaseService;
    ...
    public void setUp() throws Exception {
        ...
        devProductivityParentProfileDatabaseService.ensureTableExistence("test");
        ...
        orgDevProductivityReportV3DatabaseService = new OrgDevProductivityReportV3DatabaseService(dataSource, DefaultObjectMapper.get(), orgUnitsDatabaseService);
        orgDevProductivityReportV3DatabaseService.ensureTableExistence("test");
    }
    ...
    public void testProfileOUMappingChange() throws SQLException {
        ...
        DevProductivityParentProfile profile1 = createDevProdParentProfile(devProductivityParentProfileDatabaseService, company, scheme.getId(), 0, List.of(dbOrgUnitsV1.getRefId()));

        OrgDevProductivityReport u1p1r = OrgDevProductivityReport.builder()
                .ouID(dbOrgUnitsV1.getId()).ouRefId(dbOrgUnitsV1.getRefId()).devProductivityParentProfileId(profile1.getId())
        ...
        String id1 = orgDevProductivityReportV3DatabaseService.upsert("test", u1p1r);
        u1p1r = u1p1r.toBuilder().id(UUID.fromString(id1)).latest(true).build();
        OrgDevProductivityReport u1p1rRead = orgDevProductivityReportV3DatabaseService.get("test", id1).orElse(null);
        verifyRecord(u1p1r, u1p1rRead);

        DbListResponse<OrgDevProductivityReport> dbListResponse = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null,
        ...
        dbListResponse = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null,
        ...
        DevProductivityParentProfileDatabaseServiceTestUtils.updateProfile(devProductivityParentProfileDatabaseService, company, profile1);
        DevProductivityParentProfile profile2 = createDevProdParentProfile(devProductivityParentProfileDatabaseService, company, scheme.getId(), 1, List.of(dbOrgUnitsV1.getRefId()));

        OrgDevProductivityReport u1p2r = OrgDevProductivityReport.builder()
                .ouID(dbOrgUnitsV1.getId()).ouRefId(dbOrgUnitsV1.getRefId()).devProductivityParentProfileId(profile2.getId())
                .interval(ReportIntervalType.MONTH_JAN).startTime(now).endTime(now.plusSeconds(10L))
                .score(10).report(DevProductivityResponse.builder().orgUserId(UUID.randomUUID()).orgName("test").email("satish@levelops.io").fullName("Satish Kumar Singh").build())
                .weekOfYear(-1).year(-1)
                .missingUserReportsCount(11).staleUserReportsCount(12)
        ...
        String id2 = orgDevProductivityReportV3DatabaseService.upsert("test", u1p2r);
        u1p2r = u1p2r.toBuilder().id(UUID.fromString(id2)).latest(true).build();
        OrgDevProductivityReport u1p2rRead = orgDevProductivityReportV3DatabaseService.get("test", id2).orElse(null);
        verifyRecord(u1p2r, u1p2rRead);

        u1p1rRead = orgDevProductivityReportV3DatabaseService.get("test", id1).orElse(null);
    ...
    public void test1() throws SQLException {
        ...
        TicketCategorizationScheme scheme = TicketCategorizationSchemeDatabaseServiceTestUtils.createTicketCategorizationScheme(ticketService, company, 1);
        UUID devProdProfileId = createDevProdParentProfile(devProductivityParentProfileDatabaseService, company, scheme.getId(), 0, ouRefIds).getId();

        OrgDevProductivityReport u1v1r1 = OrgDevProductivityReport.builder()
                .ouID(dbOrgUnitsV1.get(0).getId()).ouRefId(dbOrgUnitsV1.get(0).getRefId()).devProductivityParentProfileId(devProdProfileId)
                .interval(ReportIntervalType.MONTH_JAN).startTime(now).endTime(now.plusSeconds(10L))
                .weekOfYear(-1).year(-1)
                .score(10).report(DevProductivityResponse.builder().orgUserId(UUID.randomUUID()).orgName("test").email("satish@levelops.io").fullName("Satish Kumar Singh").build())
                .missingUserReportsCount(11).staleUserReportsCount(12)
        ...
        String id1 = orgDevProductivityReportV3DatabaseService.upsert("test", u1v1r1);
        u1v1r1 = u1v1r1.toBuilder().id(UUID.fromString(id1)).latest(true).build();
        OrgDevProductivityReport u1v1r1Read = orgDevProductivityReportV3DatabaseService.get("test", id1).orElse(null);
        ...
        Assert.assertEquals(id1, orgDevProductivityReportV3DatabaseService.upsert("test", u1v1r1Updated));
        OrgDevProductivityReport u1v1r1UpdatedRead = orgDevProductivityReportV3DatabaseService.get("test", u1v1r1.getId().toString()).orElse(null);
        ...
        String id2 = orgDevProductivityReportV3DatabaseService.upsert("test", u1v1r2);
        u1v1r2 = u1v1r2.toBuilder().id(UUID.fromString(id2)).latest(true).build();
        OrgDevProductivityReport u1v1r2Read = orgDevProductivityReportV3DatabaseService.get("test", id2).orElse(null);
        ...
        Assert.assertEquals(id2, orgDevProductivityReportV3DatabaseService.upsert("test", u1v1r2Updated));
        OrgDevProductivityReport u1v1r2UpdatedRead = orgDevProductivityReportV3DatabaseService.get("test", u1v1r2.getId().toString()).orElse(null);
        verifyRecord(u1v1r2Updated, u1v1r2UpdatedRead);

        int sizeBeforeUpsert = orgDevProductivityReportV3DatabaseService.list(company, 0, 1000).getRecords().size();
        //Test Upsert
        OrgDevProductivityReport u2v1r1 = OrgDevProductivityReport.builder()
                .ouID(dbOrgUnitsV1.get(1).getId()).ouRefId(dbOrgUnitsV1.get(1).getRefId()).devProductivityParentProfileId(devProdProfileId)
                .interval(ReportIntervalType.PAST_YEAR).startTime(t0).endTime(t0)
                .weekOfYear(-1).year(-1)
                .score(10).report(DevProductivityResponse.builder().build())
                .missingUserReportsCount(11).staleUserReportsCount(12)
                .build();
        String id3 = orgDevProductivityReportV3DatabaseService.upsert(company, u2v1r1);
        u2v1r1 = u2v1r1.toBuilder().id(UUID.fromString(id3)).latest(true).build();
        int sizeAfterUpsert1 = orgDevProductivityReportV3DatabaseService.list(company, 0, 1000).getRecords().size();
        Assert.assertTrue(sizeAfterUpsert1 == sizeBeforeUpsert + 1);
        OrgDevProductivityReport u2v1r1Read = orgDevProductivityReportV3DatabaseService.get(company, id3).get();
        ...
        OrgDevProductivityReport u1v2r2 = OrgDevProductivityReport.builder()
                .ouID(dbOrgUnitsV2.get(0).getId()).ouRefId(dbOrgUnitsV2.get(0).getRefId()).devProductivityParentProfileId(devProdProfileId)
                .interval(ReportIntervalType.PAST_YEAR).startTime(now).endTime(now.plusSeconds(10L))
                .weekOfYear(-1).year(-1)
                .score(10).report(DevProductivityResponse.builder().orgUserId(UUID.randomUUID()).orgName("test").email("satish@levelops.io").fullName("Satish Kumar Singh").build())
                .missingUserReportsCount(11).staleUserReportsCount(12)
        ...
        String id4 = orgDevProductivityReportV3DatabaseService.upsert("test", u1v2r2);
        u1v2r2 = u1v2r2.toBuilder().id(UUID.fromString(id4)).latest(true).build();
        OrgDevProductivityReport u1v2r2Read = orgDevProductivityReportV3DatabaseService.get("test", id4).orElse(null);
        verifyRecord(u1v2r2, u1v2r2Read);

        DbListResponse<OrgDevProductivityReport> dbListResponse = orgDevProductivityReportV3DatabaseService
        ...
        dbListResponse = orgDevProductivityReportV3DatabaseService
    ...
    public void test() throws SQLException {
        ...
        OrgDevProductivityReport report1 = OrgDevProductivityReport.builder()
                .ouID(dbOrgUnits.get(0).getId()).ouRefId(dbOrgUnits.get(0).getRefId()).devProductivityParentProfileId(devProdProfileId)
                .interval(ReportIntervalType.MONTH_JAN).startTime(now).endTime(now.plusSeconds(10L))
                .weekOfYear(-1).year(-1)
                .score(10)
        ...
        String id1 = orgDevProductivityReportV3DatabaseService.upsert("test", report1);
        report1 = report1.toBuilder().id(UUID.fromString(id1)).latest(true).build();

        OrgDevProductivityReport report1Read = orgDevProductivityReportV3DatabaseService.get("test", id1).orElse(null);
        ...
        orgDevProductivityReportV3DatabaseService.upsert("test", report1Updated);
        OrgDevProductivityReport report1UpdatedRead = orgDevProductivityReportV3DatabaseService.get("test", report1.getId().toString()).orElse(null);
        ...
        OrgDevProductivityReport report2 = OrgDevProductivityReport.builder()
                .ouID(dbOrgUnits.get(1).getId()).ouRefId(dbOrgUnits.get(1).getRefId()).devProductivityParentProfileId(devProdProfileId)
                .interval(ReportIntervalType.PAST_YEAR).startTime(t0).endTime(t0)
                .weekOfYear(-1).year(-1)
                .score(10).report(DevProductivityResponse.builder().build())
                .missingUserReportsCount(11).staleUserReportsCount(12)
                .build();
        String id2 = orgDevProductivityReportV3DatabaseService.upsert(company, report2);
        report2 = report2.toBuilder().id(UUID.fromString(id2)).latest(true).build();
        int sizeAfterUpsert1 = orgDevProductivityReportV3DatabaseService.list(company, 0, 1000).getRecords().size();
        Assert.assertTrue(sizeAfterUpsert1 == sizeBeforeUpsert + 1);
        OrgDevProductivityReport report2Read = orgDevProductivityReportV3DatabaseService.get(company, id2).get();
        ...
        DbListResponse<OrgDevProductivityReport> dbListResponse = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, List.of(UUID.fromString(id2)), null, null, null, null, null, false);
        Assert.assertNotNull(dbListResponse);
        Assert.assertEquals(1, dbListResponse.getTotalCount().intValue());
        Assert.assertEquals(1, dbListResponse.getRecords().size());
        verifyRecord(report2, dbListResponse.getRecords().get(0));

        dbListResponse = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, List.of(UUID.fromString(id1)), null, null, null, null, null, false);
        Assert.assertNotNull(dbListResponse);
        Assert.assertEquals(1, dbListResponse.getTotalCount().intValue());
        Assert.assertEquals(1, dbListResponse.getRecords().size());
        ...
        OrgDevProductivityReport report2Updated = report2.toBuilder()
                ...
                .build();
        id2 = orgDevProductivityReportV3DatabaseService.upsert(company, report2Updated);
        int sizeAfterUpsert2 = orgDevProductivityReportV3DatabaseService.list(company, 0, 1000).getRecords().size();
        Assert.assertTrue(sizeAfterUpsert2 == sizeAfterUpsert1);
        OrgDevProductivityReport report2UpdatedRead = orgDevProductivityReportV3DatabaseService.get(company, id2).get();
    ...
    private void testListByFiltersOURefIds(Map<Integer, List<OrgDevProductivityReport>> ouRefIdToReportMap) throws SQLException {
        for(Map.Entry<Integer, List<OrgDevProductivityReport>> e : ouRefIdToReportMap.entrySet()) {
            DbListResponse<OrgDevProductivityReport> res = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null,
        ...
        DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, null, null, null, List.of(Integer.MAX_VALUE), null, false);
    ...
    private void testListByFiltersIntervals(List<OrgDevProductivityReport> allExpected) throws SQLException {
        ...
        for (ReportIntervalType interval : map.keySet()) {
            ...
            DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, null,null, List.of(interval), null, null, false);
            Assert.assertNotNull(result);
        ...
        DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, null, null,allIds, null, null, false);
        Assert.assertNotNull(result);
    ...
    private void testListByFiltersDevProductivityParentProfileIds(List<OrgDevProductivityReport> allExpected) throws SQLException {
        Map<UUID, List<OrgDevProductivityReport>> map = allExpected.stream().collect(Collectors.groupingBy(OrgDevProductivityReport::getDevProductivityParentProfileId));
        for (UUID devProductivityParentProfileId : map.keySet()) {
            List<OrgDevProductivityReport> expected = map.get(devProductivityParentProfileId);
            DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, null, List.of(devProductivityParentProfileId), null, null, null, false);
            Assert.assertNotNull(result);
            Assert.assertEquals(expected.size(), result.getTotalCount().intValue());
            Assert.assertEquals(expected.size(), result.getCount().intValue());
            verifyRecords(result.getRecords(), expected);
        }
        List<UUID> allIds = allExpected.stream().map(OrgDevProductivityReport::getDevProductivityParentProfileId).distinct().collect(Collectors.toList());
        DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, null, allIds, null, null, null, false);
        Assert.assertNotNull(result);
        Assert.assertEquals(allExpected.size(), result.getTotalCount().intValue());
        Assert.assertEquals(allExpected.size(), result.getCount().intValue());
        verifyRecords(result.getRecords(), allExpected);

        result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, null, List.of(UUID.randomUUID()), null, null, null, false);
        Assert.assertNotNull(result);
        Assert.assertEquals(0, result.getTotalCount().intValue());
        Assert.assertTrue(CollectionUtils.isEmpty(result.getRecords()));
    }
    private void testListByFiltersOUIds(List<OrgDevProductivityReport> allExpected) throws SQLException {
        ...
        for (UUID orgUserId : map.keySet()) {
            ...
            DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, List.of(orgUserId),null, null, null, null, false);
            Assert.assertNotNull(result);
            Assert.assertEquals(expected.size(), result.getTotalCount().intValue());
            Assert.assertEquals(expected.size(), result.getCount().intValue());
            verifyRecords(result.getRecords(), expected);
        ...
        DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, allIds, null, null, null, null, false);
        Assert.assertNotNull(result);
        Assert.assertEquals(allExpected.size(), result.getTotalCount().intValue());
        Assert.assertEquals(allExpected.size(), result.getCount().intValue());
        verifyRecords(result.getRecords(), allExpected);

        result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, null, List.of(UUID.randomUUID()), null, null, null, null, false);
        Assert.assertNotNull(result);
        Assert.assertEquals(0, result.getTotalCount().intValue());
        Assert.assertTrue(CollectionUtils.isEmpty(result.getRecords()));
    }
    private void testListByFiltersIds(List<OrgDevProductivityReport> allExpected) throws SQLException {
        ...
        for (UUID id : map.keySet()) {
            ...
            DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, List.of(id), null, null, null, null, null, false);
            Assert.assertNotNull(result);
            Assert.assertEquals(expected.size(), result.getTotalCount().intValue());
            Assert.assertEquals(expected.size(), result.getCount().intValue());
            verifyRecords(result.getRecords(), expected);
        ...
        DbListResponse<OrgDevProductivityReport> result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, allIds, null, null, null, null, null, false);
        Assert.assertNotNull(result);
        Assert.assertEquals(allExpected.size(), result.getTotalCount().intValue());
        Assert.assertEquals(allExpected.size(), result.getCount().intValue());
        verifyRecords(result.getRecords(), allExpected);

        result = orgDevProductivityReportV3DatabaseService.listByFilter(company, 0, 100, List.of(UUID.randomUUID()), null, null, null, null, null, false);
        Assert.assertNotNull(result);
        Assert.assertEquals(0, result.getTotalCount().intValue());
        Assert.assertTrue(CollectionUtils.isEmpty(result.getRecords()));
    }
    private void testAllListByFilters(List<OrgDevProductivityReport> allExpected, Map<Integer, List<OrgDevProductivityReport>> ouRefIdToReportMap) throws SQLException {
        ...
        testListByFiltersDevProductivityParentProfileIds(allExpected);
    ...
    private void verifyRecord(OrgDevProductivityReport expected, OrgDevProductivityReport actual) {
        ...
        Assert.assertEquals(expected.getDevProductivityParentProfileId(), actual.getDevProductivityParentProfileId());
    ...
    public void testData() throws SQLException {
        ...
        TicketCategorizationScheme scheme = TicketCategorizationSchemeDatabaseServiceTestUtils.createTicketCategorizationScheme(ticketService, company, 1);
        UUID devProdProfileId = (createDevProdParentProfile(devProductivityParentProfileDatabaseService, company, scheme.getId(), 0, List.of(orgUnit.getRefId()))).getId();

        String id2 = orgDevProductivityReportV3DatabaseService.upsert("test", OrgDevProductivityReport.builder()
                .ouID(orgUnit.getId()).ouRefId(orgUnit.getRefId())
                .devProductivityParentProfileId(devProdProfileId).devProductivityProfileTimestamp(Instant.now())
                ...
                .missingUserReportsCount(11).staleUserReportsCount(12)
                .build());
        DbListResponse<OrgDevProductivityReport> output = orgDevProductivityReportV3DatabaseService.list("test", 0, 20);
        orgDevProductivityReportV3DatabaseService.upsert("test", output.getRecords().get(0));
        OrgDevProductivityReport output2 = orgDevProductivityReportV3DatabaseService.get("test", id2).orElse(null);
        assertThat(output.getRecords().size()).isGreaterThanOrEqualTo(1);
        assertThat(output2.getScore()).isEqualTo(10);
        assertThat(orgDevProductivityReportV3DatabaseService.list("test", 0, 5).getRecords().size()).isGreaterThanOrEqualTo(1);
        orgDevProductivityReportV3DatabaseService.delete("test", id2);
        OrgDevProductivityReport output3 = orgDevProductivityReportV3DatabaseService.get("test", id2).orElse(null);
    ...
    public void testWeeklyAndBiWeeklyData() throws SQLException {
        ...
        String id1 = orgDevProductivityReportV3DatabaseService.upsert(company, expected1);
        expected1 = expected1.toBuilder().id(UUID.fromString(id1)).latest(true).build();

        OrgDevProductivityReport actual1 = orgDevProductivityReportV3DatabaseService.get(company, id1).orElse(null);
        verifyRecord(expected1, actual1);

        DbListResponse<OrgDevProductivityReport> output = orgDevProductivityReportV3DatabaseService.list(company, 0, 20);
        ...
        String id2 = orgDevProductivityReportV3DatabaseService.upsert(company, expected1);
        output = orgDevProductivityReportV3DatabaseService.list(company, 0, 20);
        ...
        String id3 = orgDevProductivityReportV3DatabaseService.upsert(company, expected1);
        output = orgDevProductivityReportV3DatabaseService.list(company, 0, 20);
        ...
        OrgDevProductivityReport actual_week_27 = orgDevProductivityReportV3DatabaseService.get(company, id3).orElse(null);
