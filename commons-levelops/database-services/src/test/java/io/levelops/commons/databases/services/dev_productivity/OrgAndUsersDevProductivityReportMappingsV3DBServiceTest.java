...
import static io.levelops.commons.databases.services.dev_productivity.DevProductivityParentProfileDatabaseServiceTestUtils.createDevProdParentProfiles;


public class OrgAndUsersDevProductivityReportMappingsV3DBServiceTest {
    ...
    OrgAndUsersDevProductivityReportMappingsV3DBService orgAndUsersDevProductivityReportMappingsV3DBService;
    ...
    public void setUp() throws Exception {
        ...
        orgAndUsersDevProductivityReportMappingsV3DBService = new OrgAndUsersDevProductivityReportMappingsV3DBService(dataSource);
...
//        tagItemService.ensureTableExistence(company);
        ...
        orgAndUsersDevProductivityReportMappingsV3DBService.ensureTableExistence(company);
    }
    ...
    public void test() throws SQLException {
        ...
        List<UUID> profiles = createDevProdParentProfiles(devProductivityParentProfileDatabaseService, company, scheme.getId(), 3).stream().map(DevProductivityParentProfile::getId).collect(Collectors.toList());
        ...
        OrgAndUsersDevProductivityReportMappings mapping1 = OrgAndUsersDevProductivityReportMappings.builder()
                .devProductivityParentProfileId(profiles.get(0)).interval(interval1).ouID(dbOrgUnits.get(0).getId()).orgUserIds(List.of(UUID.randomUUID(), UUID.randomUUID()))
                .build();
        String id = orgAndUsersDevProductivityReportMappingsV3DBService.upsert(company, mapping1);
        mapping1 = mapping1.toBuilder().id(UUID.fromString(id)).build();
        Assert.assertEquals(1, orgAndUsersDevProductivityReportMappingsV3DBService.listByFilter(company, 0, 100, null, null, null, null, null).getRecords().size());

        mapping1 = mapping1.toBuilder().orgUserIds(orgUsers).build();
        id = orgAndUsersDevProductivityReportMappingsV3DBService.upsert(company, mapping1);
        ...
        OrgAndUsersDevProductivityReportMappings mapping2 = OrgAndUsersDevProductivityReportMappings.builder()
                .devProductivityParentProfileId(profiles.get(0)).interval(interval2).ouID(dbOrgUnits.get(1).getId()).orgUserIds(List.of(orgUsers.get(0), orgUsers.get(1)))
                .build();
        id = orgAndUsersDevProductivityReportMappingsV3DBService.upsert(company, mapping2);
        mapping2 = mapping2.toBuilder().id(UUID.fromString(id)).build();
        Assert.assertEquals(2, orgAndUsersDevProductivityReportMappingsV3DBService.listByFilter(company, 0, 100, null, null, null, null, null).getRecords().size());
        ...
        OrgAndUsersDevProductivityReportMappings mapping3 = OrgAndUsersDevProductivityReportMappings.builder()
                .devProductivityParentProfileId(profiles.get(0)).interval(interval3).ouID(dbOrgUnits.get(2).getId()).orgUserIds(List.of(orgUsers.get(0)))
                .build();
        id = orgAndUsersDevProductivityReportMappingsV3DBService.upsert(company, mapping3);
        mapping3 = mapping3.toBuilder().id(UUID.fromString(id)).build();
        Assert.assertEquals(3, orgAndUsersDevProductivityReportMappingsV3DBService.listByFilter(company, 0, 100, null, null, null, null, null).getRecords().size());
        ...
        OrgAndUsersDevProductivityReportMappings mapping4 = OrgAndUsersDevProductivityReportMappings.builder()
                .devProductivityParentProfileId(profiles.get(1)).interval(interval1).ouID(dbOrgUnits.get(0).getId()).orgUserIds(List.of(orgUsers.get(1)))
                .build();
        id = orgAndUsersDevProductivityReportMappingsV3DBService.upsert(company, mapping4);
        mapping4 = mapping4.toBuilder().id(UUID.fromString(id)).build();
        Assert.assertEquals(4, orgAndUsersDevProductivityReportMappingsV3DBService.listByFilter(company, 0, 100, null, null, null, null, null).getRecords().size());
        ouRefIdToMappingMap.computeIfAbsent(dbOrgUnits.get(0).getRefId(), k -> new ArrayList<>()).add(mapping4);

        DbListResponse<OrgAndUsersDevProductivityReportMappings> res = orgAndUsersDevProductivityReportMappingsV3DBService.listByFilter(company, 0, 100, null,
        ...
        res = orgAndUsersDevProductivityReportMappingsV3DBService.listByFilter(company, 0, 100, null,
