...
@Log4j2
public class WorkItemsHopsReportServiceTest {
    ...
    public void testBouncesTimeReport() throws SQLException {
        var expectedResults = setupWorkItemHopsTimeExpectedResults();

        for (Map.Entry<WorkItemsFilter, List<DbAggregationResult>> entry : expectedResults.entrySet()) {
            DbListResponse<DbAggregationResult> actualResponse = workItemService.getWorkItemsHopsReport(COMPANY,
    ...
    private static Map<WorkItemsFilter, List<DbAggregationResult>> setupWorkItemHopsTimeExpectedResults() {
    ...
    @Test
    public void testHopsReportWithStack() throws SQLException {
        DbListResponse<DbAggregationResult> workItemsHopsReport = workItemService.getWorkItemsHopsReport(COMPANY,
        ...
        assertThat(workItemsHopsReport).isNotNull();
        assertThat(workItemsHopsReport.getTotalCount()).isEqualTo(1);
    }
    ...
    public void testExcludeStagesWithStack() throws SQLException {
        ...
        workItemsHopsReport = workItemService.getWorkItemsHopsReport(COMPANY,
                WorkItemsFilter.builder()
                        .calculation(WorkItemsFilter.CALCULATION.hops)
                        .across(WorkItemsFilter.DISTINCT.status)
                        .excludeStages(List.of("Done", "Resolved", "To Do"))
    ...
    public void testStoryPointsAgg() throws SQLException {
        DbListResponse<DbAggregationResult> result = workItemService.getWorkItemsHopsReport(COMPANY,
                WorkItemsFilter.builder()
                        .calculation(WorkItemsFilter.CALCULATION.hops)
