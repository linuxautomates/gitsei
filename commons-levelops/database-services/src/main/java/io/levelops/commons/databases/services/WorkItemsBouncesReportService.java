...
@Log4j2
@Service
public class WorkItemsBouncesReportService {
    ...
    public WorkItemsBouncesReportService(DataSource dataSource, WorkItemFieldsMetaService workItemFieldsMetaService) {
