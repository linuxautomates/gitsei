...
public enum JobStatus {
    ...
    PARTIAL_SUCCESS,    //    Job is done and successful
    ...
    public static final String SWAGGER_VALUES = "(all),unassigned,accepted,pending,success,failure,canceled,aborted,invalid";
