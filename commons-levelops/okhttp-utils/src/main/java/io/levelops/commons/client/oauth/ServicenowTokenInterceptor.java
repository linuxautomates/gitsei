...
public class ServicenowTokenInterceptor implements Interceptor {

    private final String header;
    private final String valuePrefix;
    private final OauthTokenProvider tokenProvider;

    public ServicenowTokenInterceptor(String header, String valuePrefix, OauthTokenProvider tokenProvider) {
