...
@JsonDeserialize(builder = BitbucketIterativeScanQuery.BitbucketIterativeScanQueryBuilder.class)
public class BitbucketIterativeScanQuery implements IntegrationQuery {
