...
@Log4j2
public class CxScaProjectTrigger implements TriggerRunnable {
    private static final String PROJECT_CONTROLLER_NAME = "CxScaProjectController";

    private static final String CXSCAPROJECT = "cxscaproject";
    ...
    CxScaProjectTrigger(ObjectMapper objectMapper, TriggerActionService triggerActionService) {
    ...
    public void run(DbTrigger trigger) throws Exception {
        ...
        triggerActionService.createTriggeredJob(trigger, cursor.isPartial(), CreateJobRequest.builder()
                .controllerName(PROJECT_CONTROLLER_NAME)
                .tags(cursor.getTags())
