...
public class SalesforceCaseDataSourceTest {
    ...
    public void setup() throws SalesforceClientException, InterruptedException, IOException {
        ...
        dataSource = new SalesforceCaseDataSource(salesForceClientFactory);
        ...
        SalesforcePaginatedResponse<Case> caseResponse = SalesforcePaginatedResponse.<Case>builder()
                .salesForceLocator("null")
                .records(Arrays.asList(new Case(), new Case(), new Case()))
                .build();

        when(salesForceClient.getQueryResults("1", null, Case.class)).thenReturn(caseResponse);
    }
    ...
    public void fetchMany() throws FetchException {
        List<Data<Case>> assets = dataSource.fetchMany(SalesforceIngestionQuery.builder()
                .partial(true)
