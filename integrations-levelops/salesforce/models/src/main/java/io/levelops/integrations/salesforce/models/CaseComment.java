...
public class CaseComment implements SalesforceEntity {

    public static final String SOQL_DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";

    public static final List<String> SOQL_FIELDS = Arrays.asList("CommentBody","CreatedBy.Name", "CreatedById","CreatedDate","Id",
            "IsDeleted","IsPublished","LastModifiedBy.Name", "LastModifiedById","LastModifiedDate","ParentId","SystemModstamp");
