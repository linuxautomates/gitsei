...
@JsonDeserialize(builder = GerritIterativeScanQuery.GerritIterativeScanQueryBuilder.class)
public class GerritIterativeScanQuery implements IntegrationQuery {
