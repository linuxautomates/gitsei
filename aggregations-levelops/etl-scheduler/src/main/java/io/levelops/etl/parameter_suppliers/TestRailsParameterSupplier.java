...
@Log4j2
@Service
public class TestRailsParameterSupplier implements JobDefinitionParameterSupplier {
    private final JobInstanceDatabaseService jobInstanceDatabaseService;
    @Autowired
    public TestRailsParameterSupplier(JobInstanceDatabaseService jobInstanceDatabaseService) {
    ...
    public IntegrationType getIntegrationType() {
        return IntegrationType.TESTRAILS;
    }
