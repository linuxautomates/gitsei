...
@Log4j2
@Service
public class GitlabParameterSupplier implements JobDefinitionParameterSupplier {
    private final JobInstanceDatabaseService jobInstanceDatabaseService;

    public GitlabParameterSupplier(JobInstanceDatabaseService jobInstanceDatabaseService) {
