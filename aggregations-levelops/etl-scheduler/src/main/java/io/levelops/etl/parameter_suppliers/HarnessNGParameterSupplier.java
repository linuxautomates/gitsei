...
@Log4j2
@Service
public class HarnessNGParameterSupplier implements JobDefinitionParameterSupplier {
    private final JobInstanceDatabaseService jobInstanceDatabaseService;

    @Autowired
    public HarnessNGParameterSupplier(JobInstanceDatabaseService jobInstanceDatabaseService) {
    ...
    public IntegrationType getIntegrationType() {
        return IntegrationType.HARNESSNG;
    }
