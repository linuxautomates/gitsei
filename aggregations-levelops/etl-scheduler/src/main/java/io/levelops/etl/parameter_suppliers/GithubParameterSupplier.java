...
@Log4j2
@Service
public class GithubParameterSupplier implements JobDefinitionParameterSupplier {
    private final JobInstanceDatabaseService jobInstanceDatabaseService;

    @Autowired
    public GithubParameterSupplier(JobInstanceDatabaseService jobInstanceDatabaseService) {
