...
@RestController
@RequestMapping("/v1/issue_filters")
@PreAuthorize("hasAnyAuthority('ADMIN','SUPER_ADMIN')")
@Log4j2
@SuppressWarnings("unused")
public class IssueFiltersController {

    private final static String TYPE = "issue";
    private final StoredFiltersRESTClient restClient;

    @Autowired
    public IssueFiltersController(StoredFiltersRESTClient restClient) {
